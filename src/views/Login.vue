<template>
  <div id="loginentry" class="grid grid-cols-3-border-second md:grid-cols-4-border-second h-full overflow-auto">

    <div class="hidden md:flex md:justify-center md:items-center md:col-start-4 md:row-start-1 md:row-end-9"><svg-icon icon="magelogo" /></div>
    ...
    <div class="row-start-1 col-start-3 my-0.5">
    ...
    <div class="row-start-2 col-start-3 my-0.5">
    ...
    <div class="row-start-3 col-start-3 my-0.5">
    ...
    <div class="row-start-4 col-start-3 my-0.5">
      <div class="m-0.5">
    ...
    <div class="row-start-5 col-start-3 my-0.5">
    ...
    <div class="row-start-6 col-start-3 my-0.5">
      <div v-if="!isWikiFarm">
    ...
    <div class="row-start-7 col-start-3 my-0.5">
      <input type="text" id="saveAs" name="saveAs" :disabled="addToExisting" class="w-full">
    </div>

    <div class="row-start-8 col-start-3 my-0.5">
